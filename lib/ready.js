...
/**
 * Set from compiler, if we are in standalone mode
 * we perform some hacks to reduce total size
 * @define {boolean}
 */
ss.STANDALONE = false;

/**
 * Set from compiler to false. Helps us work on node.js environment
 * @define {boolean}
 */
ss.NODEJS = true;
